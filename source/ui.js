        ...
        $.fn.JSNESUI = function (roms) {
            ...
            var UI = function (nes) {
                ...
                self.buttons = {
                    ...
                    zoom: $('<input type="button" value="全屏" class="nes-zoom">').appendTo(self.controls)
                };
                ...
                self.buttons.zoom.click(function () {
                    if (self.fullscreen) {
                        self.exitFullscreen();
                        self.buttons.zoom.attr("value", "全屏");
                        self.fullscreen = false;
                    } else {
                        self.enterFullscreen();
                        self.buttons.zoom.attr("value", "退出全屏");
            ...
            UI.prototype = {
                ...
                */
                ...
                setRoms: function (roms) {
                    ...
                    $("<option>选择游戏版本...</option>").appendTo(this.romSelect);
                ...
                exitFullscreen: function () {
                    ...
                    this.screen[0].style.width = '256px';
                    this.screen[0].style.height = '240px';
                }
            };
